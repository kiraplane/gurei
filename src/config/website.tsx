...
export const websiteConfig: WebsiteConfig = {
  ...
  metadata: {
    images: {
      ogImage: '/gurei/key-art.png',
      logoLight: '/logo.svg',
      logoDark: '/logo.svg',
    },
    social: {
      github: '',
      twitter: 'https://x.com/LoboSagazStudio',
      blueSky: '',
      discord: 'https://discord.gg/GqvKQWrMve',
      mastodon: '',
      linkedin: '',
      youtube: 'https://www.youtube.com/@gureivideogame/',
    },
  },
  features: {
  ...
  mail: {
    provider: 'resend',
    fromEmail: 'Gurei Wiki <hello@gurei.wiki>',
