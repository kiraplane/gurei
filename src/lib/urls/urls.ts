...
export const CANONICAL_BASE_URL = 'https://www.gurei.wiki';
...
function getGureiBaseUrl(url?: string) {
  ...
  try {
    ...
    if (
      parsedUrl.hostname === 'gurei.wiki' ||
      parsedUrl.hostname === 'www.gurei.wiki'
    ) {
...
export function getBaseUrl(): string {
  ...
  const gureiBaseUrl = getGureiBaseUrl(configuredBaseUrl);
  if (gureiBaseUrl) {
    return gureiBaseUrl;
  }
