...
export async function generateMetadata({
  ...
  return constructMetadata({
    title: 'Cookie Policy | Gurei Wiki',
    description:
      'How Gurei Wiki uses essential cookies, analytics, and similar technologies.',
    locale,
    pathname: '/cookie',
  });
}
    ...
    <div className="bg-[#090a0c] py-12 text-[#f3f0e8]">
      <Container className="max-w-3xl space-y-6 px-4">
        ...
        <p className="leading-8 text-[#aaa9a4]">
          Gurei Wiki uses essential cookies and similar technologies to keep the
          site working, remember basic preferences, and understand aggregate
          traffic patterns.
        </p>
        <p className="leading-8 text-[#aaa9a4]">
        ...
        <p className="leading-8 text-[#aaa9a4]">
          Questions about this policy can be sent to hello@gurei.wiki.
        </p>
      </Container>
    </div>
  );
