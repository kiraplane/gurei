...
export function Footer({ className }: React.HTMLAttributes<HTMLElement>) {
  ...
  return (
    <footer
      className={cn(
        'border-[#383b42] border-t bg-[#07080a] text-[#f3f0e8]',
        className
      )}
    >
      ...
      <div className="border-[#383b42] border-t py-8">
        <Container className="px-4 flex items-center justify-between gap-x-4">
          ...
          <span className="text-muted-foreground text-sm">
            Independent guide hub. Not affiliated with Lobo Sagaz studio,
            Astrolabe Games, Valve, Steam or YouTube.
          </span>
        </Container>
      </div>
    </footer>
