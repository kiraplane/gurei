...
const retiredPublicRouteRedirects: Array<{
  ...
  { pattern: /^\/combat(?:\/.*)?$/, target: '/guides/combat-and-dodge' },
  { pattern: /^\/boss-order(?:\/.*)?$/, target: '/guides/boss-order' },
  ...
  {
    pattern: /^\/gurei-boss-order(?:\/.*)?$/,
    target: '/guides/boss-order',
  },
  {
    pattern: /^\/gurei-download(?:\/.*)?$/,
    target: '/download',
  },
];
...
export default async function middleware(req: NextRequest) {
  ...
  const productionHosts = new Set(['gurei.wiki', 'www.gurei.wiki']);
  const canonicalHost = 'www.gurei.wiki';
